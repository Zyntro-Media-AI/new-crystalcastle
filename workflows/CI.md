  ...
  build-test:
    ...
    steps:
      ...
      - name: Save reviewer notes
        run: |
          echo "✅ Lint/Test completed successfully" > version/CrystalCastle/logs/reviewer-ci.log
          echo "Severity: Minor if lint fails, Major if test fails" >> version/CrystalCastle/logs/reviewer-ci.log